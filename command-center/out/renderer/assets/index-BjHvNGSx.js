...
function scheduleWriteBack(tracker) {
...
function selectCurrentWeek(tracker) {
  if (!tracker) return 1;
  const start = new Date(tracker.project.start_date);
  const now = /* @__PURE__ */ new Date();
  const diffDays = (now.getTime() - start.getTime()) / (1e3 * 60 * 60 * 24);
  const totalWeeks = Math.ceil(
    (new Date(tracker.project.target_date).getTime() - start.getTime()) / (1e3 * 60 * 60 * 24 * 7)
  );
  return Math.max(1, Math.min(totalWeeks, Math.floor(diffDays / 7) + 1));
}
function selectCurrentPhase(tracker) {
...
function selectScheduleStatus(tracker) {
...
function selectOverallProgress(tracker) {
  return tracker?.project.overall_progress ?? 0;
}
function selectTotalTasks(tracker) {
...
function getInitialTheme() {
  ...
  return localStorage.getItem("command-center-theme") ?? "dark";
}
const useStore = create((set, get) => ({
  ...
  updateTracker: (updater) => {
    ...
    const done = next.milestones.reduce((s, m) => s + m.subtasks.filter((t) => t.done).length, 0);
...
function TabBar() {
  ...
  const hasRecentActivity = agentLog.some((e) => {
    ...
    return Date.now() - ts < 30 * 60 * 1e3;
  });
  return /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "flex items-center gap-1 px-2", style: { WebkitAppRegion: "no-drag" }, children: TABS.map((tab) => /* @__PURE__ */ jsxRuntimeExports.jsxs(
    "button",
    {
      onClick: () => setActiveTab(tab.id),
      className: `px-3 py-1.5 rounded-md text-xs font-medium transition-colors relative ${activeTab === tab.id ? "bg-accent text-white" : "text-muted hover:text-primary-text hover:bg-surface"}`,
      children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "mr-1.5", children: tab.icon }),
        tab.label,
        tab.id === "agent-hub" && hasRecentActivity && /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "absolute -top-0.5 -right-0.5 w-2 h-2 bg-on-track rounded-full animate-pulse" })
      ]
    },
    tab.id
  )) });
...
function StatusBar() {
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center gap-4 text-xs", style: { WebkitAppRegion: "no-drag" }, children: [
    /* @__PURE__ */ jsxRuntimeExports.jsxs("span", { className: "text-muted font-mono", children: [
      "WEEK ",
      week,
      phase ? ` · ${phase}` : ""
    ] }),
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center gap-2", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "w-20 h-1.5 rounded-full bg-progress-track", children: /* @__PURE__ */ jsxRuntimeExports.jsx(
        "div",
        {
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsxs("span", { className: "font-mono text-muted", children: [
        tasks.done,
        "/",
        tasks.total,
        " (",
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: `px-2 py-0.5 rounded text-[10px] font-semibold ${statusColors[status]}`, children: statusLabels[status] }),
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center gap-1.5", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: `w-1.5 h-1.5 rounded-full ${synced ? "bg-on-track" : "bg-behind"}` }),
      /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-muted", children: synced ? "Synced" : "Offline" })
    ] }),
...
function LoadingView() {
  return /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "flex items-center justify-center h-screen bg-dark text-primary-text", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "text-center", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "animate-spin rounded-full h-8 w-8 border-b-2 border-accent mx-auto mb-4" }),
    /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-muted text-sm", children: "Loading tracker..." })
  ] }) });
}
function ErrorView({ error: error2 }) {
  return /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "flex items-center justify-center h-screen bg-dark text-behind", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "text-center", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsxs("p", { className: "text-sm", children: [
      "Error: ",
      error2
    ] }),
    /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-muted text-xs mt-2", children: "Check that project-tracker.json exists at the project root" })
  ] }) });
}
function ActiveView({ tab }) {
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex-1 overflow-auto", children: [
    tab === "swim-lane" && /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "flex items-center justify-center h-full text-muted text-sm", children: "Swim Lane view — Phase 5" }),
    tab === "task-board" && /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "flex items-center justify-center h-full text-muted text-sm", children: "Task Board view — Phase 6" }),
    tab === "agent-hub" && /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "flex items-center justify-center h-full text-muted text-sm", children: "Agent Hub view — Phase 7" }),
    tab === "calendar" && /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "flex items-center justify-center h-full text-muted text-sm", children: "Calendar view — Phase 8" })
  ] });
}
function App() {
  useStore((s) => s.tracker);
  const loading = useStore((s) => s.loading);
  const error2 = useStore((s) => s.error);
  const activeTab = useStore((s) => s.activeTab);
  const theme = useStore((s) => s.theme);
  ...
  if (loading) return /* @__PURE__ */ jsxRuntimeExports.jsx(LoadingView, {});
  if (error2) return /* @__PURE__ */ jsxRuntimeExports.jsx(ErrorView, { error: error2 });
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "h-screen bg-dark text-primary-text flex flex-col", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "h-3", style: { WebkitAppRegion: "drag" } }),
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsx(ActiveView, { tab: activeTab })
  ] });
}
